...
const CARDS = [
  ...
  },
  {
    ...
    body: 'Everything happening around your university, organised into boards — plus carpooling, campus events, and finding people to work on projects with.',
  ...
  },
  {
    ...
    body: 'Notes, study groups, and module-specific help from students who’ve actually taken the module — searchable by module code and university.',
    chips: ['Notes Exchange', 'Study Groups', 'Module Q&A', 'Exam Resources'],
    features: [
      ['Notes Exchange', 'Shared notes by module code.'],
