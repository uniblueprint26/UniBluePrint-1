...
export default function ProfileScreen({ navigation }) {
  ...
  const EXPLORE_LINKS = [
    { icon: Users,      label: 'Our Coaches',        sub: 'Browse all verified coaches',            color: '#EFF6FF', screen: null },
      ...
      >
        ...
        <View style={[styles.profileHeader, { paddingTop: insets.top + 20 }]}>
          ...
          <View style={styles.profileUniBadge}>
            <GraduationCap size={13} color="rgba(245,240,232,0.65)" />
        ...
        <View style={styles.section}>
          ...
          <View style={{ gap: 12 }}>
            {EXPLORE_LINKS.map(({ icon: Icon, label, sub, color, screen }) => (
              <TouchableOpacity
                key={label}
                activeOpacity={0.8}
...
const styles = StyleSheet.create({
  ...
  avatarCircle: {
    ...
    borderWidth: 2, borderColor: 'rgba(245,240,232,0.28)',
    alignItems: 'center', justifyContent: 'center',
    marginBottom: 14,
  },
  avatarInitials: { fontFamily: fonts.serif, fontSize: 26, color: colors.cream },
  profileName: { fontFamily: fonts.serif, fontSize: 24, color: colors.cream, marginBottom: 6 },
  profileUniBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 16 },
  ...
  upgradeBtn: { backgroundColor: colors.navy, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7 },
  ...
  versionText: { fontFamily: fonts.sans, fontSize: 12, color: colors.light, textAlign: 'center', marginTop: spacing.lg },
})
