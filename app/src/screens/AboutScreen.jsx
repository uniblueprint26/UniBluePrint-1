...
const PILLARS = [
  ...
  },
  {
    ...
    desc: 'A campus community hub — boards for accommodation, marketplace, events, lost & found, carpooling, project collaboration, and student societies. Built for your university.',
    color: '#FFF7ED',
  },
  {
    title: 'Lifestyle Blueprint',
    desc: 'Exclusive student deals from verified partners, mental health support resources, budgeting tools, and weekly money tips — built around what student life actually costs.',
    color: '#FDF4FF',
  },
  {
    title: 'Course Connect',
    desc: 'Notes sharing, study groups, module Q&A, exam resources, mentorship matching, and a student database. Everything you need to thrive academically.',
    color: '#F0F9FF',
  },
]
    ...
    >
      <View style={[styles.hero, { paddingTop: insets.top + 12 }]}>
        ...
        <Text style={styles.heroSub}>
          UniBlueprint exists to give every Irish student an equal shot at success — regardless of background, connections, or resources.
        </Text>
      </View>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.para}>
          We are a student platform built in Ireland, for Irish students. UniBlueprint bridges the gap between university and the professional world by giving students access to affordable career services, verified coaches, campus community tools, lifestyle deals, and academic resources — all in one place.
        </Text>

        <Text style={styles.sectionTitle}>The five pillars</Text>
        <View style={{ gap: 12 }}>
          {PILLARS.map(p => (
            <View key={p.title} style={[styles.pillarCard, { backgroundColor: p.color }]}>
        ...
        <Text style={styles.para}>
          We built the platform we wished existed when we were students. Every service, every feature, and every partner is chosen with one goal in mind: to genuinely help Irish students get ahead.
        </Text>
...
const styles = StyleSheet.create({
  ...
  pillarCard: { borderRadius: radius.card, padding: 16 },
