  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="UniBlueprint — Ireland's Platform for Students, Apprentices, and Young People" />
        ...
        <meta name="twitter:title" content="UniBlueprint — Ireland's Platform for Students, Apprentices, and Young People" />
