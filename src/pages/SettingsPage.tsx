...
import { Search, User, GraduationCap, Mail, Bell, Shield, Lock, CreditCard, Clock, Palette, HelpCircle, FileText, Settings } from 'lucide-react';
...
const settingsCards = [
  ...
  { title: 'My Privacy', subtitle: 'Your data, your control', icon: Shield, path: '/settings/privacy' },
  ...
  { title: 'My Display', subtitle: 'Make it yours', icon: Palette, path: '/settings/display' },
  { title: 'Blueprint Support', subtitle: 'We are here when you need us', icon: HelpCircle, path: '/settings/support' },
  { title: 'Blueprint Terms', subtitle: 'The structure behind the platform', icon: FileText, path: '/settings/terms' },
