        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          <div style={{
            ...
            <Section title="2. Essential Cookies">
              <p style={P}>TODO: Essential cookies are strictly necessary for the platform to function. They enable core features such as account authentication, session management, and security. You cannot opt out of essential cookies, as the platform cannot function without them.</p>
              <CookieTable rows={[
                ['sb-auth-token', 'Supabase authentication session', 'Session'],
                ['ubp_cookie_consent', 'Stores your cookie consent preference', '1 year'],
              ]} />
            </Section>
